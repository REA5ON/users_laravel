        ...
        <div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
            ...
            <form action="{{ route('password.update') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="username" class="form-control" placeholder="Эл. адрес" value="$request->email">
                </div>
                ...
                <button type="submit" class="btn btn-default float-right">Обновить пароль</button>
            </form>
        </div>
    </div>
