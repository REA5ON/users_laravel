                                ...
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form action="{{ route('register') }}" id="js-login" novalidate="" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="username" value="{{ old('name') }}" class="form-control" placeholder="" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="emailverify">Email</label>
                                            <input type="email" name="email" value="{{ old('email') }}" id="emailverify" class="form-control" placeholder="Эл. адрес" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password_confirmation" id="userpassword" class="form-control" placeholder="" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
