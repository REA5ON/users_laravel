                    ...
                    <div class="row no-gutters row-grid">
                        <div class="col-12">
                            <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                <img src="{{ asset(\App\Components\ImageComponent::emptyImage($profile->image))}}" class="rounded-circle shadow-2 img-thumbnail" alt="">
                        ...
                        <div class="col-12">
                            <div class="p-3 text-center">
                                ...
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> {{ $profile->job }}
                                </address>
                            </div>
                        </div>
                    </div>
