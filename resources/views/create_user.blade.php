                    ...
                    <div class="panel-container">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="job" value="{{ old('job') }}" id="simpleinput"
                                       class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" value="{{ old('phone') }}" id="simpleinput"
                                       class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="address" value="{{ old('address') }}" id="simpleinput"
                                       class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-container">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" id="simpleinput"
                                       class="form-control">
                            </div>
